...
class MarkupEditorWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
  ...
  def setup(self):
    ...
    self.markupSelector.setToolTip("Select markup to edit")
    self.parametersFormLayout.addRow("Markup: ", self.markupSelector)
    ...
    self.parametersFormLayout.addRow(self.segmentEditorWidget)
    ...
    self.segmentEditorWidget.masterVolumeNodeSelectorVisible = False
    self.segmentEditorWidget.autoShowMasterVolumeNode = False
    self.segmentEditorWidget.switchToSegmentationsButtonVisible = False
  ...
  def onEditMarkups(self):
    ...
    """
    try:
      self.logic.editMarkups(self.markupSelector.currentNode(), self.segmentEditorWidget)
...
class MarkupEditorLogic(ScriptedLoadableModuleLogic):
  ...
  def editMarkups(self, markups, segmentEditorWidget):
    """
    Edit markups
